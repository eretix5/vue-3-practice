<template>
    <header>
        <div class="head">
            ...
            <a id="about" href="/createS">Сводники</a>
        </div>
    </header>
    <center>
    <div id="app">
        <div class="container">
            ...
            <div v-if="isSuccess">
                ...
                <form
                        ...
                        :key="item.id"
                >
                    <input type="checkbox" name="file" value="Тык"/>{{item.originalName}} <br/>

                </form>
                <my-button style="margin-top: 50px;" Onclick="window.location.href='https://i.pinimg.com/originals/09/f0/4d/09f04d9662bc928a368a94f507ea1830.jpg'">Обработать</my-button>
            </div>
            <!--FAILED-->
            <div v-if="isFailed">
